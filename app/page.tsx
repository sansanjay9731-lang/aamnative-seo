        ...
        <div className="container">
          <motion.div initial="hidden" animate="show" variants={stagger}>
            ...
            <motion.h1 variants={reveal} className="h-display"
              style={{ color: "white", maxWidth: "900px", marginBottom: "0.5rem" }}>
              India's&nbsp;
              <span style={{ color: "var(--saffron-l)" }}>King</span>
            </motion.h1>
            <motion.h1 variants={reveal} className="h-display"
              style={{ color: "white", marginBottom: "2rem" }}>
              of&nbsp;<em style={{ fontStyle: "normal", fontWeight: 300, color: "rgba(255,255,255,0.75)" }}>Fruits.</em>
            </motion.h1>
